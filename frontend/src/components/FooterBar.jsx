...
function FooterBar({ onNavigate = () => {}, cartItemCount = 0 }) {
  ...
  const menuConfig = {
    // Default for guests (non-authenticated visitors)
    null: [
      ...
      { label: "Login", key: "login", icon: "fas fa-right-to-bracket" },
    ],
    // Logged-in customers
    client: [
      { label: "Home", key: "home", icon: "fas fa-home" },
      ...
      { label: "Account", key: "account", icon: "fas fa-circle-user" },
    ],
    operator: [
    ...
    admin: [
      ...
      { label: "Products", key: "products", icon: "fas fa-burger" },
      { label: "Users", key: "users", icon: "fas fa-users" },
      { label: "Logout", key: "logout", icon: "fas fa-sign-out-alt" },
    ],
  };
